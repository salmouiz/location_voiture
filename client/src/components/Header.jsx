...
import { useAppContext } from '../context/AppContext' // ✅ Import manquant ajouté
...
const Header = () => {
  ...
  const handleSearchChange = (e) => { // ✅ Paramètre (e) manquant ajouté
            ...
            <div className='relative hidden xl:flex items-center'>
              <div className={`transition-all duration-300 ease-in-out ring-1 ring-slate-900/10 bg-white rounded-full overflow-hidden ${showSearch ? "w-[266px] opacity-100 px-4 py-2" : "w-11 opacity-0 px-0 py-0"}`}>
                <input
                  ...
                  value={searchQuery} // ✅ value ajouté pour input contrôlé
                  onChange={handleSearchChange} // ✅ onChange manquant ajouté
                />
              </div>
