  ...
  return (
    <div>
      <form className="flex flex-col items-center text-sm text-slate-800">
        <p className="text-xs bg-indigo-200 text-indigo-600 font-medium px-3 py-1 rounded-full">Contactez-nous</p>
        <h1 className="text-4xl font-bold py-4 text-center">Prenons contact.</h1>
        <p className="max-md:text-sm text-gray-500 pb-10 text-center">
          Ou contactez-nous directement à <a href="#" className="text-indigo-600 hover:underline">contact@aysicar.ma</a>
        </p>
        ...
        <div className="max-w-96 w-full px-4">
          ...
          <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-indigo-400 transition-all overflow-hidden">
            ...
            <input type="text" id="name" className="h-full px-2 w-full outline-none bg-transparent" placeholder="Entrez votre nom complet" required />
          </div>

          <label htmlFor="email-address" className="font-medium mt-4">Adresse e-mail</label>
          <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-indigo-400 transition-all overflow-hidden">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <input type="email" id="email-address" className="h-full px-2 w-full outline-none bg-transparent" placeholder="Entrez votre adresse e-mail" required />
          </div>
